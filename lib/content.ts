...
export const services: Service[] = [
  ...
  },
  {
    ...
    long:
      "Строим SaaS-продукты: систему пользователей и доступов, dashboard с фильтрами и метриками, биллинг, интеграции с внешними сервисами. Архитектура рассчитана на рост — от первых пользователей до нагрузки продакшена.",
    bullets: [
  ...
  },
  {
    ...
    short: "Автоматизируют процессы, которые сейчас выполняются вручную.",
    long:
      "Проектируем внутренние корпоративные системы: автоматизацию рутинных процессов, обработку данных в фоне, интеграции между сервисами компании. Цель — снять ручную работу с команды и дать прозрачный контроль над процессом.",
    bullets: [
      "Автоматизация ручных операций",
      "Фоновые задачи, очереди, планировщики",
      "Интеграции между внутренними сервисами",
      "Наблюдаемость и логирование процессов",
    ],
  },
  {
    id: "web-apps",
