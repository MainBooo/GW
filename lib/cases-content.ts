...
export interface CaseEntry {
  ...
  problem: string
  timeframe: string
  /** Чем подтверждается работа: данные, интерфейсы, работающая система. */
  basis: string
...
export const CASES: CaseEntry[] = [
  {
    ...
    basis: "Сцена и материалы сделаны под задачу; симуляция считается на GPU в реальном времени",
  ...
  },
  {
    ...
    timeframe: "сентябрь 2026",
    basis: "Геометрия и окружение описаны знаковыми полями и считаются каждый кадр",
  ...
  },
  {
    ...
    timeframe: "сентябрь 2026",
    basis: "Рельеф построен по реальным биржевым данным: 2000 свечей BTCUSDT с Binance",
